...
import { Search, LogOut, Bell, User, Building2, Calendar, ChevronDown, ChevronUp, Shield, FileText, Zap, Calculator, PackagePlus, MapPin, Wallet, Check, X } from 'lucide-react';
              ...
              <div className="fixed inset-0 flex items-center justify-center z-[201] p-4 pointer-events-none">
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-gradient-to-r from-[#00b876] to-[#00A86B] text-white text-sm font-bold rounded-full shadow-[0_4px_12px_rgba(0,168,107,0.2)] hover:from-[#00c982] hover:to-[#00b876] transition-all disabled:opacity-50 disabled:pointer-events-none text-center focus:outline-none"
                  >
